...
public class SendGetLoginUser extends AsyncTask<Void, Void, Pengguna.penggunaData> {

    private static SendGetLoginUser _instance;
    ...
    private SendGetLoginUser.OnSendGetLoginUserListener listener;
    private ArrayList<String> Errors = new ArrayList<>();

    public static SendGetLoginUser newBuilder(){
        _instance = new SendGetLoginUser();
        return _instance;
    }

    public SendGetLoginUser setKey(String ClientKey, String ClientToken) {
        _instance.ClientToken = ClientToken;
        _instance.ClientKey = ClientKey;
        return _instance;
    }

    public SendGetLoginUser setNetworkConfig(NetworkConfig networkConfig) {
        _instance.networkConfig = networkConfig;
        return _instance;
    }

    public SendGetLoginUser setEmailPassword(String Email, String Password) {
        _instance.userDataModel.Email = Email;
        _instance.userDataModel.Password = Password;
        return _instance;
    }

    public SendGetLoginUser setOnSendGetLoginUserListener(SendGetLoginUser.OnSendGetLoginUserListener listener) {
    ...
    protected Pengguna.penggunaData doInBackground(Void... voids) {
        ...
        try {
            ...
            response = stub.loginPengguna(UserDataModelCasting.toUserDataModelGRPC(_instance.userDataModel));
        }catch (Exception e) {
    ...
    protected void onPostExecute(Pengguna.penggunaData userData) {
        ...
        try {
            ...
            if (_instance.listener != null) {
                _instance.listener.onErrorGetLoginUser(Errors);
            }
        }

        if (_instance.Errors.size() > 0 && _instance.listener != null){
            _instance.listener.onErrorGetLoginUser(_instance.Errors);
        }
